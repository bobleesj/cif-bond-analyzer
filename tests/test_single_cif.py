...
def test_cif_json_processing():
    test_cases = [
        ("tests/single_cif_file_test/1803318", {
            ...
            "Co-Er": [{"File": "1803318.cif", "Distance": 2.644, "Atomic Site": "full_occupancy"}],
        ...
        ("tests/single_cif_file_test/539016", {
            ...
            "Ga-La": [{"File": "539016.cif", "Distance": 3.291, "Atomic Site": "full_occupancy_atomic_mixing"}],
        ...
        ("tests/single_cif_file_test/560709", {
            ...
            "Co-La": [{"File": "560709.cif", "Distance": 2.979, "Atomic Site": "full_occupancy_atomic_mixing"}],
            "Ga-La": [{"File": "560709.cif", "Distance": 2.979, "Atomic Site": "full_occupancy_atomic_mixing"}],
        })
    ]
