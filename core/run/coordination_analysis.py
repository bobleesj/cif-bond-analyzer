...
def run_coordination(script_path, supercell_size=2):
    """Initiate the coordination analysis process.

    This includes prompting for analysis introduction, collecting
    directory paths with CIF files, and processing each selected
    directory.
    """
...
def _process_each_folder(dir_path, include_nested_files, supercell_size):
    ...
    cif_ensemble = CifEnsemble(
        ...
        add_nested_files=include_nested_files,
    )
