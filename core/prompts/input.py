...
def prompt_to_include_nested_files() -> bool:
    """
    Prompt the user to decide whether to include nested .cif files in each folder.
    """
...
def prompt_to_use_CN_bond_fractions() -> bool:
    """
    Prompt the user to decide whether to use bond fractions
    in coordination number geometry.
    """
    click.echo(
