...
def preprocess_move_files_based_on_format_error(dir_path):
    ...
    dir_path_bad_op = os.path.join(
        dir_path, f"{dir_name}_error_op"
    )
    ...
    for idx, file_path in enumerate(
        ...
        try:
            ...
            cif_editor.preprocess_cif_file_on_label_element(
                file_path
            )
            ...
            if (
                ...
                os.makedirs(
                    dir_path_bad_coords, exist_ok=True
                )
                debug_filename = os.path.join(
                ...
                os.makedirs(
                    dir_path_bad_label, exist_ok=True
                )
                debug_filename = os.path.join(
                ...
                os.makedirs(
                    dir_path_bad_third_line, exist_ok=True
                )
                debug_filename = os.path.join(
                ...
                os.makedirs(
                    dir_path_bad_other_error, exist_ok=True
                )
                debug_filename = os.path.join(
